...
// some units should be processed before others
class compareUnitOrderPriorities {
	public:
...
// some units should move before others to avoid getting in the way
...
// immediately.
static priority_queue<Unit, vector<Unit>, compareUnitOrderPriorities> allMyUnits;
