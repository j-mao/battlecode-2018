...
public class Player {
    ...
    public static void runEarthWorker (Unit unit) {
        ...
        // how do I decide to replicate over laying a factory blueprint? maybe I should make worker replication more lenient...
        ...
        if (!doneAction) {
            ...
            // TODO : we shouldn't really build factories so early on if doubling workers again is more worthwhile
